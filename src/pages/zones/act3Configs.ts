...
export const ZONE9_CONFIG: AssaultConfig = {
  ...
  guide: 'Hautbois studies the bands of draining colour, head tilted as if listening. "The pitch is leaving the world — you can hear it going flat." She hums one low, steady note and holds it until it stops wavering. "Keep this in your ear. When everything around you sours, you\'ll want something true to tune to."',
...
export const ZONE10_CONFIG: AssaultConfig = {
  ...
  guide: 'Hautbois braces at the rail and waves off an offered oar. "I can\'t pull with you — but I can give you the beat under the beat." Between the swells she sounds a single unwavering pitch, and the rowers find the count around it. "The sea is only dissonance. You are the resolution."',
...
export const ZONE11_CONFIG: AssaultConfig = {
  ...
  guide: 'At the edge of the dunes Hautbois goes very still. "I know this sound. It\'s the one my hands were making, in the forest." She will not look at the Hall. "Piano and Forte are extremes — one too soft to hear, one too loud to think through. Don\'t meet them on their terms. Stay in the middle, where the music actually lives."',
