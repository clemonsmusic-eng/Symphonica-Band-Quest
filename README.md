...
- **Rhythm Sudoku** — a silent notation logic puzzle in two sizes: a 6×6 "Mini
  Staff" (whole, dotted half, half, quarter, eighth, quarter rest) and a 9×9
  "Full Score" that adds dotted quarter, sixteenth and eighth rest. Every
  generated board has exactly one solution (`src/lib/minigames/rhythmSudoku.ts`,
